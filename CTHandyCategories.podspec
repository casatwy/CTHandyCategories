...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is CTHandyCategories
                   DESC

  s.homepage     = "https://github.com/casatwy/CTHandyCategories"
  ...
  s.source       = { :git => "https://github.com/casatwy/CTHandyCategories.git", :tag => s.version.to_s }
  ...
  s.source_files  = "CTHandyCategories/CTHandyCategories/**/*.{h,m}"
